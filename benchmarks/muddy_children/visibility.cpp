...
bool visible(
    ...
    throw std::runtime_error("muddy_children visibility does not know schema: " + var.schema);
}
...
const ObservationModelRegistration registration("muddy_children", observe);
